...
def process_data(data):
 ...
 # TODO: also handle max sales
  ...
  # DONE:sort data
  a=sorted(max_year.items(), key=lambda x: x[1], reverse=True)    
  #print(a)
  summary ="The {} generated the most revenue: ${}\nThe {} had the most sales: {}\nThe most popular year was {} with {} sales.".format(
      format_car(max_revenue["car"]), max_revenue["revenue"], format_car(max_sales["car"]), max_sales["total_sales"], a[0][0], a[0][1])
